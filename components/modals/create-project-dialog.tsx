      ...
      >
        <div className="p-6 pb-2">
          <DialogHeader>
            ...
            <DialogDescription className="text-neutral-400 text-sm mt-1">
              Un proyecto es un desarrollo inmobiliario, como &ldquo;Sunset
              Villas&rdquo; o &ldquo;Park Avenue Residences&rdquo;. Todos tus
              renders, videos y assets quedan organizados dentro.
            </DialogDescription>
          </DialogHeader>
        </div>
        ...
        <div className="px-6 pb-6 pt-3 flex flex-col gap-2">
          ...
          >
            ...
            Saltar &mdash; usar solo el Playground
          </button>
        </div>
      </DialogContent>
    </Dialog>
