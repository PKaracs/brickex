...
// openai, elevenlabs, sora, klingai, capcut, runway, opus

export function LogoCloud() {
  return (
    <section id="companies">
      <div className="mt-40 -mb-4 bg-background">
        <div className="container mx-auto px-4 md:px-8">
          <h3 className="text-center text-sm font-semibold">
            Produce videos without overpaying for all the tools one by one
          </h3>
          ...
          <div className="relative mt-4 flex items-center">
            <svg
              ...
              className="rotate-[250deg] text-muted-foreground"
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
            ...
            <p className="text-2xl text-muted-foreground font-caveat translate-y-5">
              * Clipstack replaces them for video production. All in one
              subscription.
            </p>
          </div>
        </div>
