...
const PROPERTIES: PropertyData[] = [
  { slug: "hollywood-hills-modern", label: "Hollywood Hills Modern", location: "Los Angeles, CA", baseDir: "real-estate-presets", variationsDir: "real-estate-variations" },
  { slug: "classic-white-mansion", label: "Neoclassical Mansion", location: "Virginia, USA" },
  { slug: "desert-modern-house", label: "Desert Modern Retreat", location: "Scottsdale, AZ" },
  { slug: "luxury-glass-skyscraper", label: "Glass Tower Residence", location: "Dubai, UAE" },
  { slug: "mediterranean-villa", label: "Mediterranean Villa", location: "Santorini, Greece", baseDir: "real-estate-presets", variationsDir: "real-estate-variations" },
  { slug: "miami-condo-tower", label: "Luxury Condo Tower", location: "Miami, FL" },
  { slug: "maldives-overwater", label: "Maldives Overwater Villa", location: "Maldives", baseDir: "real-estate-presets", variationsDir: "real-estate-variations" },
];
...
const VARIATIONS: { key: VariationKey; label: string; icon: typeof Sun }[] = [
  { key: "original", label: "Day", icon: Sun },
  { key: "night", label: "Night", icon: Moon },
  { key: "morning", label: "Sunrise", icon: Sunrise },
  { key: "overcast", label: "Moody", icon: CloudRain },
  { key: "lifestyle", label: "Staged", icon: Users },
];
          ...
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight">
              <span className="bg-gradient-to-b from-white via-neutral-100 to-neutral-400 bg-clip-text text-transparent">
                One Project. Every Mood.
              </span>
            </h2>
            <p className="text-zinc-400 mt-4 sm:mt-5 text-sm sm:text-base lg:text-lg max-w-2xl mx-auto leading-relaxed">
              Day, night, sunrise, rain, or fully staged with people and cars —
              generate any atmosphere from a single architectural drawing.
              No reshoots. No waiting for weather.
            </p>
          </div>
        </BlurFade>
              ...
              <div className="relative aspect-[16/9] w-full">
                <AnimatePresence mode="wait" initial={false}>
                  ...
                  >
                    <img
                      src={imagePath}
                      alt={`${property.label} — ${activeVariation} view`}
                ...
                <button
                  onClick={prev}
                  className="absolute left-3 sm:left-5 top-1/2 -translate-y-1/2 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-black/40 backdrop-blur-sm border border-white/10 text-white/70 hover:text-white hover:bg-black/60 hover:border-white/20 transition-all"
                ...
                <button
                  onClick={next}
                  className="absolute right-3 sm:right-5 top-1/2 -translate-y-1/2 z-10 flex h-10 w-10 items-center justify-center rounded-full bg-black/40 backdrop-blur-sm border border-white/10 text-white/70 hover:text-white hover:bg-black/60 hover:border-white/20 transition-all"
